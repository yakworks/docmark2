...
For example this is a github Pr https://github.com/yakworks/gorm-tools/pull/877
and this is for a an issue https://github.com/yakworks/gorm-tools/issues/791
...
With the `sane_lists` extension we can do

- this is list 1
- line 2

2. this should show as another list
3. not the same one
  - this is nested with 2 spaces
  - without sane_lists we need to nest it 4 spaces or a tab
